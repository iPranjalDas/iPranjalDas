...
terminal GitHub-style contribution heatmap SVG: a grid of rounded, colored BOXES
in the classic 53-week x 7-day calendar, revealed once with a diagonal line-after-line
...
# Reveal timing (one-shot cascade)
COL_T = 0.018
ROW_T = 0.045
CELL_DUR = 0.42
...
""".strip()
    ...
    parts.append(f'<text x="{canvas_w/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
                 f'text-anchor="middle">pranjal@inferics: ~/contributions --graph</text>')
